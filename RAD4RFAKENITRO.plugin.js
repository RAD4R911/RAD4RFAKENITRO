...
//#region Module Hell
const {Webpack,Patcher,Net,React,UI,Logger,Data,Components,DOM,Plugins,ContextMenu,ReactUtils,Utils} = new BdApi("RAD4RFAKENITRO");
...
// #region Exports
module.exports = class RAD4RFAKENITRO {
    constructor(meta){
        this.meta = meta;
    }
            ...
            Patcher.after(this.settingsUIMod.declarations, NameplateSection, (_, [args], ret) => {
                ...
                if(ret?.props?.children){
                    ...
                    ret.props.children.push(React.createElement("button",{
                        ...
                        children: "Change Nameplate [RAD4RFAKENITRO]",
                        onClick: () => {
        ...
        Patcher.after(this.settingsUIMod.declarations, decorationCustomizationSectionName, (_, [args], ret) => {
            ...
            if(ret?.props?.children?.props?.children){
                ret.props.children.props.children.push(
                    React.createElement("button", {
                        id: "decorationButton",
                        children: "Change Decoration [RAD4RFAKENITRO]",
                        style: {
                            width: "100px",
                            height: "50px",
                            color: "white",
    ...
    profileFxUI(){
        ...
        Patcher.after(this.settingsUIMod.declarations, ProfileEffectSectionFnName, (_, [args], ret) => {
            ...
            ret.props.children.props.children.push(
                ...
                React.createElement("button", {
                    children: "Change Effect [RAD4RFAKENITRO]",
                    className: `yabd-generic-button`,
                ...
                if((currentFile.file.size > 10485759 || settings.forceClip) && settings.useClipBypass && currentFile.file.type.startsWith("video/") 
                    ...
                    if(currentFile.file.name.toLowerCase().endsWith(".mod") && currentFile.file.type == 'video/mpeg'){
                        ...
                        if(currentFile.file.type == "video/avi"){
                            UI.showToast("[RAD4RFAKENITRO] NOTE: AVI Files may send, but HTML5 and MP4 do not support all AVI video codecs, it may not play and FFmpeg may error!", { type: "warning" });
                        }
                        try {
    ...
    async checkForUpdate(){
        try {
            ...
            UI.showToast("[RAD4RFAKENITRO] Failed to check for updates", { type: "error" });
            Logger.error(err);
        }
    ...
    newUpdateNotify(remoteMeta, remoteFile){
        ...
        UI.showNotification({
            title: "RAD4RFAKENITRO Update Available!",
        ...
        try {
            ...
            if(!currentVersionInfo.hasShownChangelog){
                UI.showChangelogModal({
                    title: "RAD4RFAKENITRO Changelog",
